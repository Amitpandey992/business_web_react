...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <div className="flex flex-row items-center y-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2">
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Our team of experts uses a methodology to identify the credit cards most likely to fit your needs. we examine annual percentage annual fees.</p>
      </div>
